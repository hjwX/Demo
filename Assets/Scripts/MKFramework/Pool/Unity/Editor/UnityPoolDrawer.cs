...
namespace MKFramework.Pool.Unity.Editor
{
    ...
    public class UnityPoolDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            allowExpandProperty.boolValue = GUI.Toggle(layoutNavigator.ReserveDrawSpace(0.25f),
                allowExpandProperty.boolValue, "Expand", buttonStyle);
            allowRecycleProperty.boolValue = GUI.Toggle(layoutNavigator.ReserveDrawSpace(0.25f),
                allowRecycleProperty.boolValue, "Recycle",
                buttonStyle);
